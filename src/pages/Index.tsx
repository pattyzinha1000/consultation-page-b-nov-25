          ...
          <div className="max-w-4xl mx-auto space-y-12 mb-12">
            ...
            <div className="border-l-4 border-accent pl-8 py-4">
              ...
              <div className="mt-8 space-y-6">
                <h3 className="text-2xl font-bold text-center mb-6">What Makes This Different:</h3>
            ...
            {/* Section 3 */}
            <div className="border-l-4 border-accent pl-8 py-4">
              <h3 className="text-2xl font-bold text-center mb-6">In Your Private Session:</h3>
            ...
            {/* Section 4 */}
            <div className="border-l-4 border-accent pl-8 py-4">
              <h3 className="text-2xl font-bold text-center mb-6">The Investment</h3>
            ...
            <div className="border-l-4 border-accent pl-8 py-4">
              ...
              <p className="text-center text-lg mb-8">(5 available consultation slots per day)</p>
